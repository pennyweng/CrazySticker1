...
public class FnMainFragment  extends Fragment {
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    private String mParam1;
    private String mParam2;
    public static FnMainFragment newInstance() {
        FnMainFragment fragment = new FnMainFragment();
        return fragment;
    }

    public FnMainFragment() {
    }
    ...
    public class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        private final String[] TITLES = { "終極密碼", "贏家紀錄"};
