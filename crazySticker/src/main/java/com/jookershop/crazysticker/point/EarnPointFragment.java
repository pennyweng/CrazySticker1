...
import com.jookershop.crazysticker.DailyTaskActivity;
...
public class EarnPointFragment extends Fragment {
    ...
    private static EarnPointFragment fragment;
...
//        if(fragment == null)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button bt0 = (Button) rootView.findViewById(R.id.Button00);
        bt0.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                ADAService.openOfferWall(EarnPointFragment.this.getActivity(),
                        483,
                        AccountUtil.getUid(EarnPointFragment.this.getActivity()));
            }
        });
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                YoumiAD.showWall(EarnPointFragment.this.getActivity());
        ...
        bt2.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                DomobOffer.show(EarnPointFragment.this.getActivity());
        ...
        bt3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                QumiAD.showTask(EarnPointFragment.this.getActivity());
            }
        });
        ...
        bt4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(EarnPointFragment.this.getActivity(), DailyTaskActivity.class);
                EarnPointFragment.this.getActivity().startActivity(intent);
            }
        });
...
//                FacebookSdk.setIsDebugEnabled(true);
                if (sp.contains("fb_share")) {
                    Message.ShowMsgDialog(EarnPointFragment.this.getActivity(), "之前已經分享過了，謝謝支持。");
                } else {
                    try {
...
//                            ShareDialog shareDialog = new ShareDialog(ActiveMenuFragment.this.getActivity());
                            MainActivity.shareDialog.registerCallback(MainActivity.callbackManager, new FacebookCallback<Sharer.Result>() {
                                ...
                                public void onSuccess(Sharer.Result result) {
                                    ...
                                    String uid = URLEncoder.encode(AccountUtil.getUid(EarnPointFragment.this.getActivity()));
                                    ...
                                    AsyncHttpClient.getDefaultInstance().executeString(ahg,
                                            new AsyncHttpClient.StringCallback() {
                                                ...
                                                public void onCompleted(Exception e,
                                                    ...
                                                    if (e != null) {
                                                        Message.ShowMsgDialog(EarnPointFragment.this.getActivity(), "發生錯誤，請稍候再試。");
                                                        e.printStackTrace();
                                                        return;
                                                    }

                                                    if (EarnPointFragment.this != null
                                                            && EarnPointFragment.this.getActivity() != null)
                                                        if (result.indexOf("err") == -1 && result.indexOf("#") != -1) {
                                                            sp.edit().putBoolean("fb_share", true).commit();
                                                            Message.ShowMsgDialog(EarnPointFragment.this.getActivity(), "分享成功，點數增加至" + result.split("#")[0] + "點");
                                                        } else if (result.equals("err:1")) {
                                                            Message.ShowMsgDialog(EarnPointFragment.this.getActivity(), "之前已經分享過了，點數不會再增加");
                                                        } else {
                                                            Message.ShowMsgDialog(EarnPointFragment.this.getActivity(), "發生錯誤，請稍候再試。");
                                                        }
                                                }
                        ...
                        } else Message.ShowMsgDialog(EarnPointFragment.this.getActivity(), "發生錯誤，請稍候再試。");
                    } catch (Throwable e) {
                        Message.ShowMsgDialog(EarnPointFragment.this.getActivity(), "發生錯誤，請稍候再試。");
                    }
                }
...
//		loadPointCount();
        ...
        AsyncHttpClient.getDefaultInstance().executeString(ahg,
                new AsyncHttpClient.StringCallback() {
                    ...
                    public void onCompleted(Exception e,
                        ...
                        if (EarnPointFragment.this != null
                                && EarnPointFragment.this.getActivity() != null)
                            EarnPointFragment.this.getActivity()
    ...
    public void onResume() {
        loadPointCount();
        super.onResume();
        updateTime(EarnPointFragment.this.getActivity());
    }
