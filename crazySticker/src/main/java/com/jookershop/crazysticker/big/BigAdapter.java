...
public class BigAdapter extends ArrayAdapter<BigHistory> {
	private Context mContext;
	private DisplayImageOptions options;
	private SharedPreferences sp;
	private SimpleDateFormat formatter;

	public BigAdapter(Context context, ArrayList<BigHistory> interestItems,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		final BigHistory postItem = getItem(position);
		View rowView = convertView;

		if (rowView == null) {
			rowView = LayoutInflater.from(getContext()).inflate(
					R.layout.big_item, parent, false);
		...
		holder.title.setText(postItem.getBaseNumber());
