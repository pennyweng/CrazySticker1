        ...
        AsyncHttpClient.getDefaultInstance().executeString(ahg,
				new AsyncHttpClient.StringCallback() {
					...
					public void onCompleted(Exception e,
						...
						if (ReturnProductFragment.this != null
								&& ReturnProductFragment.this.getActivity() != null)
							ReturnProductFragment.this.getActivity()
	...
	public void loadItmes(final boolean first) {
		...
		AsyncHttpClient.getDefaultInstance().executeJSONArray(ahg, new AsyncHttpClient.JSONArrayCallback() {
			...
			public void onCompleted(Exception e, AsyncHttpResponse response, JSONArray result) {
				if (ReturnProductFragment.this != null && ReturnProductFragment.this.getActivity() != null)
					ReturnProductFragment.this.getActivity().runOnUiThread(new Runnable() {
						public void run() {
